...
@section('content')
	...
	@component('mails.templates.tables.services', ['services' => $services, 'comments' => $comments])
	@endcomponent
	...
	@component('mails.templates.tags.p')
		...
		- выбираете ранее указанные вами услуги и день в ближайший месяц, в который вы готовы выполнить их со скидкой <br>
		- можете добавить одну дату, несколько дат или даже диапазон. Вы ничем не ограничены
