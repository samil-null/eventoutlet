                        ...
                        <td>
                          <table style="width:500px;border-spacing:0;border-collapse: collapse;">
                            @foreach ($services as $service)
                                <tr>
                                    <td style="border:1px solid #ccc; padding:10px;">{{ $service->name }}</td>
                                    <td style="border:1px solid #ccc; padding:10px;">{{ $service->price }} {{ $service->priceOption->name }}</td>
                                    <td style="border:1px solid #ccc;padding:10px;">{{ $service->getStatus() }}</td>
                                </tr>
                            @endforeach
