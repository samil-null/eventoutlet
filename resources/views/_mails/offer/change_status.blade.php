                        ...
                        <td>
                          <table style="width:500px;border-spacing:0;border-collapse: collapse;">
                            @foreach ($offers as $offer)
                                <tr>
                                    <td style="border:1px solid #ccc; padding:10px;">{{ $offer['service_name'] }} {{ $offer['dates'] }}</td>
                                    <td style="border:1px solid #ccc; padding:10px;">{{ $offer['price'] }} {{ $offer['price_option'] }}</td>
                                    <td style="border:1px solid #ccc;padding:10px;">{{ $offer['status_name'] }}</td>
                                </tr>
                            @endforeach
