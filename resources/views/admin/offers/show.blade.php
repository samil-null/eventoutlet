                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group focused">
                                            <label class="form-control-label" for="input-username">Услуга</label>
                                            <input type="text" id="input-username" class="form-control form-control-alternative" disabled placeholder="Название" value="{{ $offer->service->name }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
